...
public class LoginController {
    ...
    private static String USER_NAME = "sagormridha";  // GMail user name (just the part before "@gmail.com")
    private static String PASSWORD = "sagormridha"; // GMail password
    ...
    private static void sendFromGMail(String from, String pass, String[] to, String subject, String body) {
        ...
        try {
            message.setFrom(new InternetAddress("sarfanarnab@gmail.com", "Ayaan phrma Ltd."));
