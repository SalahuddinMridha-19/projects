...
import com.sagor.pharmacymanagement.repo.RoleRepo;
...
public class UserController {
    ...
    public String saveUser(){
        ...
        User user=new User("sagor","sagormridha@gmail.com","sagor", passwordEncoder.encode("1234567"),true, roles);
        userRepo.save(user);
        ...
        User user1=new User("Mortoza","mortoza@gmail.com","mortoza001", passwordEncoder.encode("1234567"),true, roles1);
        userRepo.save(user1);

        Set<Role> roles2=new HashSet<>();
        roles2.add(new Role(2L));
        User user2=new User("Mostafiz","mostafiz@gmail.com","mostafiz001", passwordEncoder.encode("1234567"),true, roles2);
        userRepo.save(user2);


        Set<Role> roles3=new HashSet<>();
        roles3.add(new Role(3L));
        User user3=new User("Rony","rony@gmail.com","rony", passwordEncoder.encode("1234567"),true ,roles3);
        userRepo.save(user3);
        return "sucess";
    }
}
