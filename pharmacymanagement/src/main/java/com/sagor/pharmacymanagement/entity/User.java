package com.sagor.pharmacymanagement.entity;
...
public class User {
 ...
 private long fileSize;
   ...
   private String fileExtension;
    ...
    public User(String name, String email, String userName, String password, Date birthDate, boolean enabled, String confirmationToken, Set<Role> roles) {
        this.name = name;
        this.email = email;
    ...
    public User( String name,  String email,  String userName,  String password, boolean enabled, Set<Role> roles) {
        this.name = name;
        this.email = email;
        this.userName = userName;
        this.password = password;
